...
def perform_evaluation(model, builder, eval_steps, ckpt, strategy, topology):
    ...
    def single_step(features, labels):
        _, _, supervised_head_outputs = model(features, training=False)
...
def main(argv):
    ...
    #/scratch/ssd004/scratch/haojin/tfds/imagenet
    ...
    if FLAGS.mode == 'eval':
        ...
        def single_step(features, labels):
            with tf.GradientTape() as tape:
                ...
                projection_head_outputs, supervised_head_outputs, pred_label = model(
        ...
        with strategy.scope():
            ...
            while cur_step < train_steps:
                ...
                with summary_writer.as_default():
                    ...
                    if cur_step > step_to_check:
                        perform_evaluation(model, builder, eval_steps,
                                           checkpoint_manager.latest_checkpoint, strategy,
                                           topology)
                        step_to_check += steps_per_epoch
